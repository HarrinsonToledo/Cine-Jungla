...
<body>
    <div class="contenedor">
        ...
        <form action="hello-servlet" <% if (login.getComando_login() == 1) {out.print("style=\"display: none\"");}%>>
            ...
            <input name="password" type="password" class="form-control" placeholder="Contraseña" aria-label="Contraseña" aria-describedby="addon-wrapping">
            <div class="d-grid gap-2">
    ...
    <%
        if (login.getPersona_logueada() == 3) {
            out.print("<script>\n" +
                    "        alert(\"Persona no encontrada\")\n" +
                    "    </script>");
            login.setPersona_logueada(0);
        }
    %>
</body>
</html>
