...
<body>
    <nav class="navbar navbar-dark bg-dark mb-0 px-5" id="nav-bar">
        <h1 style="color: white"><b>Cine jungla</b></h1>
        ...
        <form action="hello-servlet">
            <button id="titan" type="submit" name="boton" value="titan">
                <div class="card" style="width: 25em; margin-bottom: 2%;">
                    <img class="card-img-top" src="https://img.lalr.co/cms/2020/08/25110421/TITAN2.jpg" alt="Card image cap">
                    <div class="card-body">
            ...
            <button id="unicentro" type="submit" name="boton" value="unicentro">
                <div class="card" style="width: 25em; margin-bottom: 2%;">
                    <img class="card-img-top" src="https://confidencialcolombia.com/wp-content/uploads/2020/06/unicentro-1-scaled.jpg.webp" alt="Card image cap">
                    <div class="card-body">
            ...
            <button id="plaza-central" type="submit" name="boton" value="plaza-central">
                <div  class="card" style="width: 25em; margin-bottom: 2%;">
                    <img class="card-img-top" src="https://www.semana.com/resizer/JkE44R4DOcknyKWvnC6V29cAu28=/1200x675/filters:format(jpg):quality(50)//cloudfront-us-east-1.images.arcpublishing.com/semana/HUFPZ5NJVRHSFKLYY5P5YGNXOU.jpg" alt="Card image cap">
                    <div class="card-body">
            ...
            <button id="embajador" type="submit" name="boton" value="embajador">
                <div class="card" style="width: 25em; margin-bottom: 2%;">
                    <img class="card-img-top" src="https://res.cloudinary.com/civico/image/upload/c_fit,f_auto,fl_lossy,h_1200,q_auto:low,w_1200/v1422034516/entity/image/file/2ab/001/520d3e1f31e93c55770012ab.jpg" alt="Card image cap">
                    <div class="card-body">
            ...
            <button id="las-americas" type="submit" name="boton" value="las-americas">
                <div class="card" style="width: 25em; margin-bottom: 2%;">
                    <img class="card-img-top" src="https://res.cloudinary.com/civico/image/upload/c_fit,f_auto,fl_lossy,h_1200,q_auto:low,w_1200/v1445381643/entity/image/file/02d/000/5626c60ab9dd5d7bac00002d.jpg" alt="Card image cap">
                    <div class="card-body">
