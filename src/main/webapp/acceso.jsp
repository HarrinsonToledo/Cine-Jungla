...
<head>
    ...
    <link rel="stylesheet" href="EstilosGeneral/acceso-style.css">
    ...
    <form action="hello-servlet">
        <div id="empleado" class="card" style="width: 18rem;">
            ...
            <div class="card-body">
                ...
                <a href="login.jsp"><button name="boton" value="empleado" class="btn btn-primary">acceder</button></a>
            </div>
        </div>
        <div id="cliente" class="card" style="width: 19.5rem;">
            ...
            <div class="card-body">
                ...
                <a href="login.jsp"><button name="boton" value="cliente" class="btn btn-primary">acceder</button></a>
            </div>
        </div>
    </form>
</body>
